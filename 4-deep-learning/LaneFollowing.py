...
def stabilize_steering_angle(curr_steering_angle, new_steering_angle, num_of_lane_lines, max_angle_deviation_two_lines=5, max_angle_deviation_one_lane=1):
    ...
    angle_deviation = new_steering_angle - curr_steering_angle #Angle de déviation = 98 (droite) - 90 (tout droit) = 8 
    ...
    if(stabilized_steering_angle > 90 + 45):
        stabilized_steering_angle =  90 + 45
    if (stabilized_steering_angle < 90 - 45):
        stabilized_steering_angle = 90 - 45
